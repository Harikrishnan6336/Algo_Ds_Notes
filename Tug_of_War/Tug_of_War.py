...
def TOW(array, n, curr_elements, no_of_selected_elements, soln, min_diff, Sum, current_sum, current_pos): 
    ...
    TOW(array, n, curr_elements, no_of_selected_elements, soln, min_diff, Sum, current_sum, current_pos + 1) 

    # Add the current element to the solution set
    no_of_selected_elements += 1
    current_sum = current_sum + array[current_pos] 
    curr_elements[current_pos] = True
    ...
    curr_elements[current_pos] = False
